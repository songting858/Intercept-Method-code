%process data from pair_EI_VClamp_REV80.dat or multi_EI_VClamp_REV80.dat which corresponds to reversal potentials VE1 and VI1
...
if multi_input_case==0
    data_origin=load('pair_EI_VClamp_REV80.dat');
    data=data_origin(:,195/dt+1:end);
else
    data_origin=load('multi_EI_VClamp_REV80.dat');
